...
import com.leegm.session.util.Client;
...
public class ApplicationTests {
    ...
    void test() throws InterruptedException {
        ...
        for (int i = 0; i < clientSize; i++) {
            clients.add(new Client(i, clientCount, protocolEncoder, clientInitLatch, latch, "127.0.0.1", port, ApplicationTests::callBack));
        }
